...
yay -S --noconfirm arduino-ide-bin dataspell drawio-desktop dropbox ipscan networkmanager-openconnect notion-app-electron proton-vpn-gtk-app protonmail-bridge teams-for-linux-git ttf-ms-win11-auto yubico-authenticator-bin zoom
